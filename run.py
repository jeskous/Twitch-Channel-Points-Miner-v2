...
twitch_miner = TwitchChannelPointsMiner(
    username="RiseOfNoko",
    password=os.getenv("TWITCH_PASS"),           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            chat_id=7376748883,                                                      # Chat ID to send messages @getmyid_bot
            token="7944887551:AAGV7Uf87G3YV5ufUTMyv7HoQ1EUYEmaUzk",                          # Telegram API token @BotFather
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION,
                    Events.MOMENT_CLAIM, Events.BET_WIN,
                    Events.DROP_CLAIM, Events.BONUS_CLAIM],                          # Only these events will be sent to the chat
...
twitch_miner.mine(
    [
        Streamer("DJBWAY"),
        Streamer("NoWay4u_Sir"),
        Streamer("Autophil"),
        Streamer("xTheSolutionTV"),
        Streamer("kutcherlol"),
        Streamer("DJMarcusKreutzfeldt"),
        Streamer("MontanaBlack88"),
